# causal-crm-uplift-modeling
An advanced CRM optimization project utilizing Uplift Modeling and Stacking Ensembles to maximize marketing ROI and target persuadable customers.
...
**CausalCRM** is a next-generation marketing optimization project designed to isolate and target only the **"Persuadables"**—customers who will buy *only* if they receive a specific marketing action. By leveraging causal inference and advanced machine learning architectures, this project transforms raw campaign data into strategic financial value, maximizing Return on Investment (ROI) while minimizing campaign fatigue.

### 🛠️ Technical Superpowers
- **Metodology:** Uplift Modeling (Causal Inference) using the `scikit-uplift` framework.
- **Data Engineering:** Custom domain-driven interaction features (`Digital Affinity`, `Value Density`) to enhance feature importance.
...
---
*This project was developed as a Final Graduation Project for the Miuul Data Science Bootcamp.*
